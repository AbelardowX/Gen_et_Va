...
if section == "Home / Introduction":
    ...
    Gen et Va is a commodity market monitoring and trade support platform designed for energy, metals, and agricultural futures. 
    It automates market monitoring by calculating risk metrics, cross-market relationships, and seasonality while providing an interactive 
    ...
    This project was developed to strengthen my technical and market knowledge while preparing for Trading Assistant and Middle Office
    roles within commodity trading houses. It combines data engineering, market analysis, risk monitoring, and visualization into a single workflow.
